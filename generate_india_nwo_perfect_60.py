...
def generate_india_nwo_perfect_60():
    chapter_names = [
    ...
    for i in range(7):
        for j in range(pages_per_ch[i]):
            ...
            # Special: Chapter 1 first page with Image at TOP
            if i == 0 and j == 0:
                pdf.set_font('Poppins', 'B', 26)
    ...
    pdf.output("India_New_World_Order_Perfect_60.pdf")
    ...
    for i in range(7):
        for j in range(pages_per_ch[i]):
            ...
            # Image in Chapter 1 first page at TOP
    ...
    doc.save("India_New_World_Order_Perfect_60.docx")

print("Restoring PERFECT 60-page dissertation with Image at Top...")
generate_india_nwo_perfect_60()
print("Success.")
