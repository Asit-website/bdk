...
def generate_economic_diplomacy_strict_60():
    chapter_names = [
    ...
    pdf.output("Economic_Diplomacy_Strict_60.pdf")
    ...
    doc.save("Economic_Diplomacy_Strict_60.docx")

print("Generating STRICT 60-page dissertation with reduced font size...")
generate_economic_diplomacy_strict_60()
print("Success.")
