...
const SaleChallanActionMenu = ({ isOpen, anchorRect, onClose }) => {
    ...
    const menuWidth = 200;
    const menuHeight = 400; // Estimated height for 11 items
    ...
    const actionItems = [
        ...
        { label: 'Generate e-Invoice', icon: <FileCheck size={14} /> },
        { label: 'Convert To Return', icon: <RotateCcw size={14} /> },
        { label: 'Preview Delivery Challan', icon: <Truck size={14} /> },
        { label: 'Payment History', icon: <History size={14} /> },
        { label: 'Cancel Invoice', icon: <XSquare size={14} /> },
        { label: 'Delete', icon: <Trash2 size={14} />, isDelete: true },
        { label: 'Duplicate', icon: <Copy size={14} /> },
        { label: 'Open PDF', icon: <FileText size={14} /> },
        { label: 'Preview', icon: <ExternalLink size={14} /> },
...
export default SaleChallanActionMenu;
