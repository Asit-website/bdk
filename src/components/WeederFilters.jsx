...
const WeederFilters = () => {
    ...
    return (
        <div className="filters-section">
            ...
            <div className="filter-top-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                <div className="search-transactions" style={{ backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '8px 15px', display: 'flex', alignItems: 'center', width: '300px' }}>
                ...
                <div className="filter-actions" style={{ display: 'flex', gap: '10px' }}>
                    <button className="btn btn-sale" style={{ color: '#ef4444', backgroundColor: '#fee2e2', border: 'none', padding: '8px 15px', borderRadius: '6px', fontWeight: '500', fontSize: '13px' }}>+ Add Sale</button>
                    <button className="btn btn-purchase" style={{ color: '#3b82f6', backgroundColor: '#dbeafe', border: 'none', padding: '8px 15px', borderRadius: '6px', fontWeight: '500', fontSize: '13px' }}>+ Add Purchase</button>
                    <button className="btn-icon" style={{ backgroundColor: '#dbeafe', color: '#3b82f6', border: 'none', padding: '8px', borderRadius: '6px', display: 'flex', alignItems: 'center' }}><Plus size={18} /></button>
                    <button className="btn-icon" style={{ backgroundColor: '#f1f5f9', color: '#64748b', border: 'none', padding: '8px', borderRadius: '6px', display: 'flex', alignItems: 'center' }}><MoreVertical size={18} /></button>
                </div>
            </div>
            ...
            <div className="filter-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <div className="filter-row-right" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <button
                        ...
                        onClick={() => navigate('/purchase/add-bill')}
                    >
                        + Add Purchase Bill
                    </button>

                    <button className="btn-settings" style={{ background: '#f1f5f9', border: 'none', padding: '8px', borderRadius: '6px', cursor: 'pointer' }}>
            ...
            <div className="filter-selectors" style={{ display: 'flex', alignItems: 'center', gap: '15px', borderTop: '1px solid #f1f5f9', paddingTop: '20px' }}>
                <div className="filter-group" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    <div className="select-wrapper" style={{ position: 'relative' }}>
                        <select className="select-input" style={{ backgroundColor: '#f1f5f9', border: 'none', padding: '6px 30px 6px 15px', borderRadius: '6px', fontSize: '13px', appearance: 'none', fontWeight: '500', color: '#1e293b' }}>
