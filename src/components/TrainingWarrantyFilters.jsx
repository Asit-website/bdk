...
import './QuotationFilters.css'; // Reusing premium filter styles

const TrainingWarrantyFilters = ({ openModal }) => {
        ...
        <div className="quotation-filters-container">
            ...
            <div className="filter-middle-bar">
                <div className="quotation-title-group">
                    <h2 className="quotation-title">TRAINNING & WARANTY</h2>
                    <ChevronDown size={20} className="title-chevron" />
                </div>
                <div className="quotation-actions-right">
                    <button className="btn-add-quotation" onClick={openModal}>
...
export default TrainingWarrantyFilters;
