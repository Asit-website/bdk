        ...
        <div className="quotation-filters-container">
            ...
            <div className="filter-middle-bar">
                <div className="quotation-title-group">
                    <h1 className="quotation-title">Estimate</h1>
                    <ChevronDown size={20} className="title-chevron" />
                </div>
                <div className="quotation-actions-right">
                    <button className="btn-add-quotation" onClick={() => navigate('/sales/spare/estimate/add')}>
            ...
            <div className="filters-selectors-bar">
                ...
                <div className="filter-group">
                    <div className="date-wrapper">
                        ...
                        <input type="date" value="2026-02-01" className="date-input-hidden" readOnly />
                        <span className="date-separator">To</span>
                        <input type="date" value="2026-02-28" className="date-input-hidden" readOnly />
                    </div>
                </div>
                <div className="filter-group">
