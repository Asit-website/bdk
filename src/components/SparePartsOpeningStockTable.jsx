...
const PurchaseActionMenu = ({ isOpen, anchorRect, onClose, onCurrentStock }) => {
    ...
    return createPortal(
        <div className="action-dropdown shadow-lg" style={style}>
            ...
            <button className="dropdown-item" onClick={() => { onCurrentStock(); onClose(); }}>
                <Search size={14} /> Current Stock
            </button>
...
const SparePartsOpeningStockTable = () => {
    ...
    const columns = [
        'Sl No.', 'Part No', 'Part Name', 'Qty', 'Rate', 'Rack No', 'Bin No', 'Taxable Amount', 'Total Amount'
    ];
    ...
    return (
        <div className="table-container" ref={tableRef} style={{ marginTop: '20px' }}>
            ...
            <PurchaseActionMenu
                ...
                onCurrentStock={() => setIsStockModalOpen(true)}
            />
...
export default SparePartsOpeningStockTable;
