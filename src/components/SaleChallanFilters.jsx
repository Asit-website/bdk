...
import { Search, Plus, Calendar, ChevronDown, Download, Printer, Filter, Settings, MoreVertical } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import './QuotationFilters.css';

const SaleChallanFilters = () => {
        ...
        <div className="quotation-filters-container">
            ...
            <div className="filter-middle-bar">
                <div className="quotation-title-group">
                    <h2 className="quotation-title">Sale Challan</h2>
                    <ChevronDown size={20} className="title-chevron" />
                </div>
                <div className="quotation-actions-right">
                    <button className="btn-add-quotation" onClick={() => navigate('/sales/weeder/challan/add')}>
                        <Plus size={18} /> Add Sale Challan
                    </button>
...
export default SaleChallanFilters;
