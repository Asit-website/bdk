    ...
    const data = [
        {
            ...
            srNo: 1,
            billDate: '12/03/2026',
            receiptDate: '20/03/2026',
            party: 'ABCD LTD',
            branch: 'ABCD',
            invoiceNo: '304',
            product: 'WEEDER',
            purchaseType: 'GST NON GST',
            billAmount: 500
        }
    ];

    const columns = [
        'Sr No.', 'Bill Date', 'Receipt Date', 'Party', 'Branch', 'Invoice No.', 'Product', 'Purchase Type', 'Bill Amount'
    ];
