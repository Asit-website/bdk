...
const SparePartsSaleBillFilters = () => {
        ...
        <div className="quotation-filters-container">
            ...
            <div className="filter-middle-bar">
                ...
                <div className="quotation-actions-right">
                    <button className="btn-add-quotation" style={{ backgroundColor: '#22c55e' }} onClick={() => navigate('/sales/spare/bill/add')}>
...
export default SparePartsSaleBillFilters;
