...
import { ChevronRight, Calendar, Edit2, Trash2, Plus, Upload, Save, X, RefreshCcw, Maximize2, Search, ChevronDown } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import './AddQuotationPage.css'; // Reusing established styles for consistency

const AddSaleBillPage = () => {
    const navigate = useNavigate();
    const [rows, setRows] = useState([
        { id: 1, item: '', qty: 1, unit: 'Sale', priceUnit: 'Without Tax', discount: 0, tax: 'Select', amount: 0 },
        { id: 2, item: '', qty: 1, unit: 'Sale', priceUnit: 'Without Tax', discount: 0, tax: 'Select', amount: 0 }
    ]);

    const addRow = () => {
        const newId = rows.length > 0 ? Math.max(...rows.map(r => r.id)) + 1 : 1;
        setRows([...rows, { id: newId, item: '', qty: 1, unit: 'Sale', priceUnit: 'Without Tax', discount: 0, tax: 'Select', amount: 0 }]);
    };
                ...
                <div className="form-grid">
                    <div className="form-group">
                        ...
                        <div className="date-input-wrapper">
                            <input type="date" className="form-input-date" defaultValue="2026-03-14" onClick={(e) => e.target.showPicker && e.target.showPicker()} />
                    ...
                    <div className="form-group">
                        ...
                        <div className="date-input-wrapper">
                            <input type="text" className="form-input-text" placeholder="Search Challan" />
                            <Search size={16} className="date-icon" />
                        </div>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="form-input-text" placeholder="Enter Battery No" />
                    </div>
                    <div className="form-group">
                        <label>Address</label>
...
export default AddSaleBillPage;
