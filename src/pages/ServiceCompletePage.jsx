...
import './ServiceCompletePage.css';
...
const ServiceCompletePage = () => {
    ...
    const rows = [
        ...
        },
        {
            ...
            problem: 'view',
            serviceType: 'PAID',
            workingDate: '24/03/2025 7:45PM',
            status: 'COMPLETE',
            Machanic: 'SANDIP SINGH',
            problems: ['Starting Problem', 'Fuel Filter', 'Gear Oil Leakage', 'Crank Pin Bearing', 'Steering Handle', 'Clutch Not Working'],
        },
    ];
    ...
    return (
        <div className="page-container">
            <div className="filters-section service-dashboard-filters">
                ...
                <div className="filter-row">
                    ...
                    <div className="filter-row-right">
                        <button className="btn btn-primary btn-add-service" onClick={() => setIsServiceModalOpen(true)}>+ Add New Service</button>
            ...
            <div className="complete-summary-card">
                <div className="service-stat-card tone-green complete-summary-card-inner">
                    <span className="service-stat-title">Total Complete Service</span>
                    <span className="service-stat-divider" />
                    <span className="service-stat-value">18,000</span>
                </div>
            </div>
                        ...
                        <tbody>
                            {rows.map((row, index) => (
                                <tr key={row.id}>
                                    ...
                                    <td>
                                        <span className="service-status complete">COMPLETE</span>
                                    </td>
                                    <td>{row.Machanic}</td>
