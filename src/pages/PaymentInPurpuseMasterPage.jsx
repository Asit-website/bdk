...
const PaymentInPurpuseMasterPage = () => {
    const navigate = useNavigate();
    const [purpuses, setPurpuses] = useState([
        { id: 1, name: 'BOOKING ADVANCE' },
        { id: 2, name: 'SPARE PARTS' },
        { id: 3, name: 'AGAINST BILL' }
    ]);
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Payment In Purpuse</span>
            </div>

            <div className="quotation-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Payment In Purpuse</h2>
...
export default PaymentInPurpuseMasterPage;
