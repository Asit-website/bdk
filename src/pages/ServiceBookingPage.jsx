...
import MechanicAssignModal from '../components/MechanicAssignModal';
import ServiceBookingUpdateModal from '../components/ServiceBookingUpdateModal';
    ...
    return (
        <div className="page-container">
            ...
            <div className="booking-summary-card">
                <div className="service-stat-card tone-orange booking-summary-card-inner">
                    <span className="service-stat-title">Total Service Booked</span>
                    <span className="service-stat-divider" />
                    <span className="service-stat-value">30,000</span>
                </div>
            </div>
                        ...
                        <tbody>
                            {rows.map((row, index) => (
                                <tr key={row.id}>
                                    ...
                                    <td>
                                        <span className="service-status booked">BOOKED</span>
                                    </td>
                                    <td className="service-booking-action">
                                        <button 
                                            className="assign-mechanic-btn" 
                                            type="button"
                                            onClick={() => {
                                                setSelectedRow(row);
            ...
            {openActionId && actionAnchor && createPortal(
                ...
                >
                    <button 
                        ...
                        onClick={() => {
                            setSelectedRow(rows.find(r => r.id === openActionId));
                            setIsMechanicModalOpen(true);
                            setOpenActionId(null);
                        }}
                    >
