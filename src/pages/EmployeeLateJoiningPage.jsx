...
import './EmployeeLateJoiningPage.css';

const EmployeeLateJoiningPage = () => {
    const navigate = useNavigate();
    const [openActionId, setOpenActionId] = useState(null);
    const [actionAnchor, setActionAnchor] = useState(null);

    const rows = [
        { id: 1, name: 'SUDHIR MURMU', inTime: '8:31 AM', outTime: '8:30 PM', comment: '', inTone: 'red', outTone: '' },
        { id: 2, name: 'CHANDI PATRA', inTime: '8:31 AM', outTime: '8:30 PM', comment: '', inTone: 'red', outTone: '' },
        { id: 3, name: 'VADU SAREN', inTime: '8:50 AM', outTime: '8:30 PM', comment: '', inTone: 'red', outTone: '' },
        { id: 4, name: 'KUSH PATRA', inTime: '8:50 AM', outTime: '7:30 PM', comment: '', inTone: 'red', outTone: 'red' },
        { id: 5, name: 'UTPAL MAKUR', inTime: '8:33 AM', outTime: '8:10 PM', comment: '', inTone: 'red', outTone: 'red' },
        { id: 6, name: 'SANDIP SINGH', inTime: '8:50 AM', outTime: '8:30 PM', comment: '', inTone: 'red', outTone: '' },
        { id: 7, name: 'CHANDAN MANDI', inTime: '8:50 AM', outTime: '8:30 PM', comment: '', inTone: 'red', outTone: '' },
    ];
    ...
    return (
        <div className="page-container">
            ...
            <div className="late-card-strip">
                <div className="employee-stat-card tone-amber late-single-card">
                    <div className="employee-stat-top">
                        <span className="employee-stat-value">12</span>
                        <Eye size={16} />
                    </div>
                    <span className="employee-stat-title">Late Joining</span>
                </div>
            </div>
                                    ...
                                    <td>
                                        <div className="employee-name-cell">
                                            ...
                                            <button
                                                ...
                                                onClick={() => navigate('/employee/profile', { state: { employee: row, from: '/employee/attendance/late' } })}
                                            >
                                                {row.name}
                                            </button>
                                        </div>
...
export default EmployeeLateJoiningPage;