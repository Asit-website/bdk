    ...
    return (
        <div className="page-container">
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Debit Note</span>
            </div>

            <div className="purchase-form-card credit-note-card">
                <div className="form-header">
                    <h2 className="form-main-title">Debit Note</h2>
                ...
                <div className="credit-note-top-grid">
                        ...
                        {showPartyList && (
                            <div className="credit-party-list">
                                ...
                                <button type="button" className="credit-party-row" onClick={() => { setPartyName('CHANDI PATRA'); setShowPartyList(false); }}>
                                    ...
                                    <span className="balance green">0</span>
                                </button>
                                <button type="button" className="credit-party-row" onClick={() => { setPartyName('SOURAV KUNDU'); setShowPartyList(false); }}>
                                    ...
                                    <span className="balance red">500</span>
                                </button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="credit-note-right-meta">
                        <div className="credit-meta-row">
                            ...
                            <input type="text" className="form-input-text" defaultValue="1" />
                        </div>
                        <div className="credit-meta-row">
                        ...
                        <div className="credit-meta-row">
                            <label>Date</label>
                            <div className="date-input-wrapper">
                                <input type="date" className="form-input-date" defaultValue="2026-03-17" onClick={(e) => e.target.showPicker && e.target.showPicker()} />
                                <Calendar size={16} className="date-icon" />
                            </div>
                        </div>
                        <div className="credit-meta-row">
