...
import EngineChassisModal from '../components/EngineChassisModal';
import './AddPurchaseBillPage.css';

const AddPurchaseBillPage = () => {
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <span className="breadcrumb-item active">Purchase Bill</span>
            </div>

            <div className="purchase-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Purchase Bill</h2>
                                ...
                                <tr key={row.id}>
                                    ...
                                    <td>
                                        <div className="item-actions">
                                            <button className="action-btn edit" onClick={() => handleOpenECModal(row.id)}><Edit2 size={14} /></button>
                                            <button className="action-btn delete" onClick={() => deleteRow(row.id)}><Trash2 size={14} /></button>
                                            <button className="action-btn add" onClick={() => handleOpenECModal(row.id)}><Plus size={14} /></button>
                                        </div>
                                    </td>
