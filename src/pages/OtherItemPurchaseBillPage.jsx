...
import './OtherItemPurchaseBillPage.css';

const OtherItemPurchaseBillPage = () => {
    ...
    return (
        <div className="page-container">
            <div className="breadcrumbs">
                ...
                <span className="breadcrumb-item active">Other's Item Purchase</span>
            </div>

            <div className="purchase-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Other's Item Purchase</h2>
                            ...
                            {rows.map((row, index) => (
                                <tr key={row.id}>
                                    ...
                                    <td className="unit-col">
                                        <select className="table-input unit-select">
                                            <option>Nos</option>
                                            <option>NONE</option>
                                            <option>Pcs</option>
                                            <option>Box</option>
                                    ...
                                    <td>
                                        <div className="tax-input-group">
                                            <select className="table-input tax-select">
                                                <option>Tax (%)</option>
                                                <option>5%</option>
                                                <option>12%</option>
                                                <option>18%</option>
                                            ...
                                            <input type="number" className="table-input tax-amount-input" placeholder="Amount" />
                                        </div>
                                    </td>
...
export default OtherItemPurchaseBillPage;
