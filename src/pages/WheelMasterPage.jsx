...
const WheelMasterPage = () => {
    ...
    const addWheelSize = () => {
        if (newValue.trim()) {
            setWheelSizes([...wheelSizes, { id: wheelSizes.length + 1, name: newValue }]);
            setNewValue('');
        }
    };

    const deleteWheelSize = (id) => {
        setWheelSizes(wheelSizes.filter(w => w.id !== id));
    };
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Wheel Master</span>
            </div>

            <div className="quotation-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Wheel Master</h2>
                ...
                <div className="category-master-content">
                    ...
                    <div className="create-section-pm">
                        ...
                        <div className="create-input-group">
                            ...
                            />
                            <button className="btn-add-pm" onClick={addWheelSize} style={{ backgroundColor: '#22c55e' }}>
                                    ...
                                    <tr key={wheel.id}>
                                        ...
                                        <td>
                                            <div className="category-actions-pm">
                                                ...
                                                <button className="action-btn-pm delete" onClick={() => deleteWheelSize(wheel.id)}><Trash2 size={13} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
...
export default WheelMasterPage;
