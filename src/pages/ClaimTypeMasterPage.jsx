...
const ClaimTypeMasterPage = () => {
    ...
    const addClaim = () => {
        if (newValue.trim()) {
            setClaims([...claims, { id: claims.length + 1, name: newValue.toUpperCase() }]);
            setNewValue('');
        }
    };
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Claim Type Master</span>
            </div>

            <div className="quotation-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Claim Type Master</h2>
                ...
                <div className="category-master-content">
                    ...
                    <div className="create-section-pm">
                        ...
                        <div className="create-input-group">
                            ...
                            />
                            <button className="btn-add-pm" onClick={addClaim} style={{ backgroundColor: '#22c55e' }}>
                                    ...
                                    <tr key={claim.id}>
                                        ...
                                        <td>
                                            <div className="category-actions-pm">
                                                ...
                                                <button className="action-btn-pm delete" onClick={() => deleteClaim(claim.id)}><Trash2 size={13} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
...
export default ClaimTypeMasterPage;
