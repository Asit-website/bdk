...
import './ServiceOngoingPage.css';

const ServiceOngoingPage = () => {
    ...
    return (
        <div className="page-container">
            ...
            <div className="ongoing-summary-card">
                <div className="service-stat-card tone-violet ongoing-summary-card-inner">
                    <span className="service-stat-title">Total Ongoing Service</span>
                    <span className="service-stat-divider" />
                    <span className="service-stat-value">13,000</span>
                </div>
            </div>
                        ...
                        <tbody>
                            {rows.map((row, index) => (
                                <tr key={row.id}>
                                    ...
                                    <td>
                                        <span className="service-status ongoing">ONGOING</span>
                                    </td>
                                    <td>{row.Machanic}</td>
...
export default ServiceOngoingPage;
