...
import './AddSparePartsOpeningStockPage.css';
import './AddPurchaseBillPage.css';

const AddSparePartsOpeningStockPage = () => {
    ...
    return (
        <div className="page-container">
            <div className="breadcrumbs">
                ...
                <span className="breadcrumb-item active">Add Parts Opening Stock</span>
            </div>

            <div className="purchase-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Add Parts Opening Stock</h2>
                ...
                <div className="form-grid">
                    ...
                    <div className="form-group">
                        <label>GST Amount & Percentage</label>
                        <select className="form-input-select">
...
export default AddSparePartsOpeningStockPage;
