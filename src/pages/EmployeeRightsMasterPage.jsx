...
import './EmployeeRightsMasterPage.css';

const EmployeeRightsMasterPage = () => {
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Employee Rights Master</span>
            </div>

            <div className="quotation-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Employee Rights Master</h2>
                ...
                <div className="form-content-pm">
                    ...
                    {/* Filter Toolbar aligned with latest Designation Rights preferences */}
                    <div className="rights-toolbar">
                        <div className="pm-field">
                            <div className="select-wrapper">
                                <select className="pm-input">
                                    <option value="">Select Employee</option>
                                    <option value="1">BABURAM HEMBRAM</option>
                                    <option value="2">KAZI FAHIM</option>
                                </select>
                            </div>
                        </div>
                        <div className="pm-field">
...
export default EmployeeRightsMasterPage;
