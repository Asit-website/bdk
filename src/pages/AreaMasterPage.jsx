...
const AreaMasterPage = () => {
    ...
    const addArea = () => {
        if (newValue.trim()) {
            setAreas([...areas, { id: areas.length + 1, name: newValue.toUpperCase() }]);
            setNewValue('');
        }
    };
    ...
    return (
        <div className="page-container">
            ...
            <div className="breadcrumbs">
                ...
                <ChevronRight size={14} className="breadcrumb-separator" />
                <span className="breadcrumb-item active">Area Master</span>
            </div>

            <div className="quotation-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Area Master</h2>
                ...
                <div className="category-master-content">
                    ...
                    <div className="create-section-pm">
                        ...
                        <div className="create-input-group">
                            ...
                            />
                            <button className="btn-add-pm" onClick={addArea} style={{ backgroundColor: '#22c55e' }}>
                                    ...
                                    <tr key={area.id}>
                                        ...
                                        <td>
                                            <div className="category-actions-pm">
                                                ...
                                                <button className="action-btn-pm delete" onClick={() => deleteArea(area.id)}><Trash2 size={13} /></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
