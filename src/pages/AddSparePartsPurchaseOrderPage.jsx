...
const AddSparePartsPurchaseOrderPage = () => {
    ...
    return (
        <div className="page-container">
            <div className="breadcrumbs">
                ...
                <span className="breadcrumb-item active">Add Purchase Order</span>
            </div>

            <div className="purchase-form-card">
                <div className="form-header">
                    <h2 className="form-main-title">Add Purchase Order</h2>
                        ...
                        <tbody>
                            {rows.map((row, index) => (
                                <tr key={row.id}>
                                    ...
                                    <td><input type="text" className="table-input" /></td>
                                    <td className='modal-desc'>< input type="text" className="table-input" /></td>
...
export default AddSparePartsPurchaseOrderPage;
